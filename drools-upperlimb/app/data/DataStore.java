...
public class DataStore{
    ...
    private static Map<String, Patient> initializePatients(){
        ...
        patient1.addSession(session11.getSession_id());

        Sess session12 = new Sess();
        _addSession(patient1.getUserID(),session12);
        patient1.addSession(session12.getSession_id());
        ...
        patient2.addSession(session21.getSession_id());
        ...
        patient3.addSession(session31.getSession_id());
